...
class Setkelas_m extends CI_Model
{
    ...
    public function getTahunAkademik($id)
    {
        return $this->db->get_where('tahun_akademik', array('id' => $id))->row_array();
    }
    ...
    public function getSiswa($tahun_id, $kelas_id, $semester)
    {
    ...
    public function save_to_destination_class($ids, $tahun_tujuan_id, $kelas_tujuan_id, $semester)
    {
    ...
    public function delete_permanently($ids, $tahun_tujuan, $kelas_tujuan, $semester)
    {
        $walikelas_id = 0;
        $query = $this->db
            ->select('idwali_kelas')
