...
class Nilai extends CI_Controller
{
    ...
    public function input($kelas_kd, $mapel_kd)
    {
        ...
        if ($this->mapel_m->getDataByCode($mapel_kd)["kategori"] == "Ekstrakurikuler") {
            $data['content'] = 'nilai/eskul';
        } else {
    ...
    public function save_kkm($id)
    {
        ...
        $data = siswa_by_kelas(_active_years()->idtahun_akademik, _active_years()->semester, $idkelas);
    ...
    public function save($kelas_kd)
    {
        ...
        foreach (siswa_by_kelas(_active_years()->idtahun_akademik, _active_years()->semester, $idkelas) as $row) {
            ...
            $data = [
                ...
                'nilai_huruf_ketrampilan' => $this->input->post('gradeKetrampilan' . $row->idsiswa, true),
