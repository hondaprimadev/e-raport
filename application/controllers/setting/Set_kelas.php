...
class Set_kelas extends CI_Controller
{
    ...
    public function get_siswa_asal()
    {
        ...
        $data = $this->setkelas_m->getSiswa($tahun_id, $kelas_id, _active_years()->semester);
    ...
    public function save_siswa_to_class()
    {
        ...
        $query = $this->setkelas_m->save_to_destination_class($ids, $tahun_tujuan_id, $kelas_tujuan_id, _active_years()->semester);
    ...
    public function delete()
    {
        ...
        $query = $this->setkelas_m->delete_permanently($ids, $tahun_tujuan, $kelas_tujuan, _active_years()->semester);
        $this->vars['status'] = $query ? 'success' : 'error';
